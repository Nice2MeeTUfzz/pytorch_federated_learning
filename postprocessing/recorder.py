...
if __name__ == '__main__':
    recorder = Recorder()
    # res_files:文件夹下的所有文件列表
    res_files = [f for f in os.listdir("../results/test_cifar10")]
    for f in res_files:
        recorder.load(os.path.join("../results/test_cifar10", f), label=f)
    # print(recorder.res_list)
    recorder.plot()
    # plt.show()
